    ...
    return (
      <Centered>
        <div className="instructions">
          ...
          <p>
            &emsp;&emsp;在每一轮任务中，您需要{" "}
            <strong>将一些学生分配到不同的房间里</strong>。
            学生对居住房间的满意度在0到100之间（见网页窗口左下方），
            总得分越高，即意味着学生的满意度越高。{" "}
          </p>

          <p>
            &emsp;&emsp;<strong>操作：</strong>
            您需要通过鼠标 <strong>拖拽</strong>{" "}
            学生至某个房间以完成这一项任务。可以试试下面这个例子:
          </p>
          ...
          <div style={{ textAlign: "center" }}>
            <p style={{ color: "green" }}>
              <strong>温馨提示：只有当所有学生都被分配了房间，才会显示得分。（可以有空房间）</strong>
            </p>
          </div>
