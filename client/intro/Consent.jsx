    ...
    return (
      <Centered>
        <div className="consent bp3-ui-text">
          <h2 className="bp3-heading" style={{ textAlign: "center" }}> 实验知情同意书 </h2>
          <p>
          您好，非常感谢您能够抽时间参与本实验。请详细阅读以下说明：
          </p>
          <h5 className="bp3-heading">实验介绍：</h5>
          <p>
          本实验旨在了解影响团体任务协作绩效的相关因素。在实验过程中，您会遇到一系列问题，需要您和团队另外两位成员共同协作解决问题。
          实验内容不会对您的心理和生理产生任何不良影响。实验预计耗时                 
          <em style={{ color: "red" }}>40</em> 分钟。
          </p>
          <h5 className="bp3-heading">实验报酬：</h5>
          <p>
          认真按要求完成实验内容，您可以获得一定的实验报酬，报酬具体金额取决于您在实验任务中的具体表现，
          后面我们会详细介绍实验报酬的计算规则。在您的实验结果经过审核后，
          我们将通过支付宝转账的方式将实验报酬发放至您的账户，
          因此，实验过程中需要您填写支付宝账号并留下您的联系方式。
          </p>

          <h5 className="bp3-heading">信息收集：</h5>
          <p>
          我们将记录并保存您在实验过程中的动作（如鼠标点击）、成员间的沟通内容等
          以及收集您的年龄、性别等个人信息。我们收集的以上信息仅用于学术研究，
          您的所有个人资料和实验结果我们都将严格保密，不会外传，
          且您的个人信息不会出现在最终的研究结果中。
          </p>

          <h5 className="bp3-heading">退出自由：</h5>
          <p>
            <strong>您的参与完全基于自愿原则，您有权在任何阶段退出实验任务，
              不会因为退出实验而受到处罚或损失，且您的数据将不会纳入研究结果。</strong> 
          </p>
          <p>
          如果您同意参加本次实验，请点击“我同意”。若您不同意参加本次实验，可以直接退出，感谢您的阅读~
          </p>
