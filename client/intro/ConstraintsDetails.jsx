      ...
      <Centered>
        <div className="instructions">
          ...
          <p>
            ...
            &emsp;&emsp;在给学生分配房间时您需要考虑一些{" "}
            <strong>约束条件</strong>
            。比如：有的学生不能住在同一个房间，有的学生必须是邻居。
          </p>
          <p> &emsp;&emsp;这些约束条件因任务而异，您可以尝试下面这个例子：</p>
          ...
          <div style={{ textAlign: "center" }}>
            <p style={{ color: "green" }}>
              <strong>温馨提示：每违反一次约束条件将会从团队得分中扣除100分！</strong>
            </p>
            {/* <p style={{ color: "green" }}>
              <strong>可以有空房间，但您必须分配所有的学生。</strong>
            </p> */}
          </div>
  ...
  renderRoom(room, isDeck) {
    ...
    return (
      ...
      >
        ...
        {isDeck ? null : <h6 className={"bp3-heading"}>房间 {room}</h6>}
      ...
      >
        ...
        <span className="icon">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192 512">
            {/* <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 79 200"> */}
            <path
              style={style}
